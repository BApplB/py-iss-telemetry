...
tm_items = ["AIRLOCK000001","AIRLOCK000002","AIRLOCK000003","AIRLOCK000004","AIRLOCK000005","AIRLOCK000006",
...
def on_item_update(item_update):
    telemetry_history.append(item_update["values"])
    print("{TimeStamp}: Value {Value} - Status: {Status} - ".format(**item_update["values"]))
